...
setTimeout(function(){ log('PlugB4E est maintenant ' + active.fontcolor('lightgreen') + '. Version 1.0') },1000);
...
function initUIListeners()
{
        ...
        $('#plugbot-btn-meh').live('click', function()
        {
				...
				API.sendChat("/em vient d'activer l'auto-Dislike! :loudspeaker:");
...
function populateUserlist()
{
        ...
        $('#plugbot-userlist').append('<p style="padding-left:12px;text-indent:0px !important;font-style:italic;color:#FFFF6B;font-size:12px;">Rejoins notre site sur<br />boost4ever.fr</p><br />');
        ...
        if ($('#button-dj-waitlist-view').attr('title') !== '')
        {
                if ($('#button-dj-waitlist-leave').css('display') === 'block' &&
                        ...
                        $('#plugbot-userlist').append('<h1 id="plugbot-queuespot"><span style="font-variant:small-caps">Liste D'attente:</span> ' + spot + '</h1><br />');
                }
        }
